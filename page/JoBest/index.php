...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <img class="d-inline-block me-3" src="<?=$CMSNT->site('logo');?>" alt="" width="200px" />
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              <li class="nav-item px-2"><a class="nav-link fw-medium active" aria-current="page" href="<?=BASE_URL('');?>"><?=lang(120);?></a></li>
              <li class="nav-item px-2"><a class="nav-link fw-medium" href="<?=BASE_URL('Auth/ForgotPassword');?>"><?=lang(122);?></a></a></li>
            </ul>
            <form class="ps-lg-5">
              <a class="btn btn-lg btn-primary rounded-pill bg-gradient order-0" type="button" href="<?=BASE_URL('Dashbroad');?>"><?=lang(1);?></a>
            </form>
          </div>
        </div>
      </nav>
      <section class="py-0" id="home">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-sm-none" style="background-image:url(<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->
      ...
      <section class="py-5">
        <div class="bg-holder" style="background-image:url(<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/bg.png);background-position:left top;background-size:initial;margin-top:-180px;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-0 text-center text-md-start"><img class="img-fluid mb-4" src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/passion.png" width="450" alt="" /></div>
      ...
      <section class="py-0">
        ...
        <div class="container">
          ...
          <section class="py-8">
            ...
            <div class="container">
              <div class="row flex-center">
                <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/jobs.png" width="450" alt="" /></div>
                <div class="col-md-5 text-center text-md-start">
      ...
      <section class="py-5">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/category-bg.png);background-position:right top;background-size:200px 320px;">
        </div>
        <!--/.bg-holder-->
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/finance.png" height="120" alt="" />
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/design.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/programmer.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/production.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/education.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/consultancy.png" height="120" alt="" />
                      <div class="card-body px-2">
      ...
      <section class="py-8">
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/feature.png" width="450" alt="" /></div>
            <div class="col-md-5 text-center text-md-start">
      ...
      <section class="py-0"><img class="w-100" src="<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/come-on-join.png" alt="" />
        <div class="container">
                    ...
                    <div class="row h-100 m-lg-7 mx-3 mt-6 mx-md-4 my-md-7">
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="<?=BASE_URL('page/JoBest/');?>assets/img/gallery/user-1.png" alt="" /></div>
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="<?=BASE_URL('page/JoBest/');?>assets/img/gallery/user-2.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="<?=BASE_URL('page/JoBest/');?>assets/img/gallery/user-3.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
      ...
      <section class="py-0 bg-primary-gradient">
        <div class="bg-holder" style="background-image:url(<?=BASE_URL('page/JoBest/');?>assets/img/illustrations/footer-bg.png);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
